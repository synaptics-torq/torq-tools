...
class OnnxModelExporterBase(ABC):
    ...
    def __init__(
        ...
        *,
        ...
        opt_config: ORTOptimizerConfig | None = None,
        ...
        for d in [self._export_dir, self._convert_dir, self._iree_dir]:
            if d.exists():
    ...
    def export_onnx(self, validate: bool = True):
        ...
        for comp, model in self._components.items():
            ...
            if self._opt_config:
                self.optimize_model(self._export_paths[comp], self._opt_config)
            if self._static_models:
    ...
    def convert_models(
        ...
        if not self._convert_dtypes:
            ...
            return
        convert_dir = convert_dir or self._convert_dir
        skip = skip or []
    ...
    def export_iree(
        ...
        iree_export_dir = iree_export_dir or self._iree_dir
        skip = skip or []
