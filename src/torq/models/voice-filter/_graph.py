...
class AiVadOnnxGraphEditor(OnnxGraphEditor, CommonGraphEditsMixin, CombineKVCacheMixin):
    ...
    def fix_encoder_io(
        self,
        Sigmoidout_mask_dim_0: int,
        Sigmoidout_mask_dim_1: int,
        Concathidden_state_dim_1: int
    ):
        to_fix = [
            FixedDimMapping("Sigmoidout_mask_dim_0", DimMatchType.EXACT, Sigmoidout_mask_dim_0),
            FixedDimMapping("Sigmoidout_mask_dim_1", DimMatchType.EXACT, Sigmoidout_mask_dim_1),
