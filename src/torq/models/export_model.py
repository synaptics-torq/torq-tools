...
from .ppocr import add_ppocr_export_args
...
def main():
    ...
    ppocr = model.add_parser("ppocr", help="Export PP-OCRv6-tiny (paddle-paddle) OCR to Torq")
    add_ppocr_export_args(ppocr)
    ...
    elif args.model_name == "ppocr":
        from .ppocr.export import export_ppocr_from_args
        export_ppocr_from_args(args)
