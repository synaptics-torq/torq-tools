...
def validate(models_dir: str, model_size: str = "tiny"):
    ...
    logger = logging.getLogger("validate_2_split")
    ...
    logger.info("Initialising MoonshineStreaming2Split runner...")
...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Validate 2-Split Moonshine Streaming.")
